...
public class CircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    /**
     * Set a color to be drawn behind the circle-shaped drawable. Note that this has no effect if the
     * drawable is opaque or no drawable is set.
     *
     ...
     * drawable is opaque or no drawable is set.
     *
     * @param fillColorRes The color resource to be resolved to a color and drawn behind the drawable
     * @deprecated Fill color support is going to be removed in the future
     */
    @Deprecated
