...
//        default_text_size = Util.sp2px(getResources(), 18);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        suffixText = TextUtils.isEmpty(attributes.getString(R.styleable.ArcProgress_arc_suffix_text)) ? default_suffix_text
        ...
        textColor = ContextCompat.getColor(getContext(), R.color.startColor);
    }
...
//    String text = getProgress() + "%";
        String text = String.valueOf(getProgress()).split("\\.")[0]; // 소수점 없애기
