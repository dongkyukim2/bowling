...
public class GraphViewModel extends BaseViewModel {
  ...
  private MutableLiveData<ArrayList<ScoreModel>> graphLiveData = new MutableLiveData<>();
  ...
  protected void onCreated() {
    ...
    BowlingApi.getInstance().getScoreMonthAgvDayList(getYearMonth(),
        receivedData -> {
          graphLiveData.setValue(receivedData.getData());
          graphLoading = false;
  ...
  public MutableLiveData<ArrayList<ScoreModel>> getGraphLiveData() {
